...
## Frameworks
- [iPlug2](https://github.com/iPlug2) - iPlug (originally created by Cockos) is an awesome plug-in framework. I was maintaining a fork of it since ~2011 called [WDL-OL](https://github.com/olilarkin/wdl-ol) which is now superseded by [iPlug2](https://github.com/iPlug2). Starting in 2018, [Alex Harker](https://github.com/AlexHarker) and I made a big effort to update it, and now it's nearly done. iPlug2 is a massive improvement on the original version, adding support for GPU accelerated vector graphics via SKIA and NanoVG, iOS AUv3 and compiling to WASM, amongst many other things. iPlug2's syntax is super simple, for example, creating a parameter or a control in the UI is only a single line of C++ code.
...
- [csound](https://github.com/csound/csound) - CSound is still going strong and a lot of interesting scores/orchestras/UDOs are about. It can also be used as an embeddable DSP library.
